...
{
    public partial class Minny_Casino_AffiliateContext : DbContext
    {
        public Minny_Casino_AffiliateContext()
        {
        }

        public Minny_Casino_AffiliateContext(DbContextOptions<Minny_Casino_AffiliateContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("Host=dbcardano.crbu3tdpw97d.us-east-2.rds.amazonaws.com;Database=MinnyCasinoAffiliate;Username=dbAdmin;Password=Jr2Ge4FvY!=Z5u!^");
            }
        }
